...
for jsonl_id in range(start, end):
    ...
    jsonl_file_path = f"../data/triplet_fact_judgement_run/{data_name}/{save_doc_name}/result_docred_{data_name}_triplet_fact_judgement-{save_doc_name}_{jsonl_id}.jsonl"
