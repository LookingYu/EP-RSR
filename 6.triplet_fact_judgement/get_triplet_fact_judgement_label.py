...
file_path = f"../data/check_result_triplet_fact_judgement_jsonl/{data_name}/result_docred_{data_name}_triplet_fact_judgement_0-{docred_len}-{save_doc_name}.jsonl"
