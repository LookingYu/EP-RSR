...
train_doc_filename = f"../data/docred/train_annotated.json"
...
train_file_path = "../data/check_result_relation_summary_jsonl/train_annotated/result_docred_train_annotated_relation_summary_0-3053.jsonl"
train_annotated_jsonl_data = read_jsonl(train_file_path)


dev_file_path = f"../data/check_result_relation_summary_jsonl/{data_name}/result_docred_{data_name}_relation_summary_0-{dev_docred_len}.jsonl"
dev_jsonl_data = read_jsonl(dev_file_path)

print("data loading successful")
print('--------------------------------------')

train_embeddings = np.load('../data/get_embeddings/train_annotated_embeddings_0-3053.npy')
print("train_embeddings loading successful")
print('--------------------------------------')


dev_embeddings = np.load(f'../data/get_embeddings/{data_name}_embeddings_0-{dev_docred_len}.npy')
